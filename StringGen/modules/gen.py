...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@AlishaUpdates"))
        else:
            ...
            await client.join_chat("AlishaUpdates")
    except KeyError:
        pass
    try:
